...
public partial class TESTContext : DbContext
{
    ...
    public virtual DbSet<現有人員查詢> 現有人員查詢 { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<WIP_001_生產回報_產出資料>(entity =>
        {
            ...
            entity.Property(e => e.HOST_NAME)
                ...
                .IsUnicode(false);
            entity.Property(e => e.KEYIN_DATE).HasColumnType("datetime");
            entity.Property(e => e.季).HasComputedColumnSql("(datepart(quarter,[生產日期]))", true);
            entity.Property(e => e.年)
                .HasMaxLength(30)
                .IsUnicode(false)
                .HasComputedColumnSql("(CONVERT([varchar],datepart(year,[生產日期]),(0)))", true);
            entity.Property(e => e.年月)
                .HasMaxLength(35)
                .IsUnicode(false)
                .HasComputedColumnSql("((CONVERT([varchar],datepart(year,[生產日期]),(0))+'/')+right('0'+CONVERT([varchar],datepart(month,[生產日期]),(0)),(2)))", true);
            entity.Property(e => e.建檔日期)
                .HasDefaultValueSql("(getdate())")
                .HasColumnType("datetime");
            entity.Property(e => e.抽樣數量).HasDefaultValueSql("((0))");
            entity.Property(e => e.日)
                .HasMaxLength(4)
                .IsUnicode(false)
                .HasComputedColumnSql("(right('0'+CONVERT([varchar],datepart(day,[生產日期]),(0)),(2)))", true);
            entity.Property(e => e.星期)
                .HasMaxLength(2)
                .IsUnicode(false)
                .HasComputedColumnSql("(case datepart(weekday,[生產日期]) when (1) then '日' when (2) then '一' when (3) then '二' when (4) then '三' when (5) then '四' when (6) then '五' when (7) then '六'  end)", false);
            entity.Property(e => e.月)
                .HasMaxLength(4)
                .IsUnicode(false)
                .HasComputedColumnSql("(right('0'+CONVERT([varchar],datepart(month,[生產日期]),(0)),(2)))", true);
            ...
            entity.Property(e => e.生產班別)
                ...
                .HasMaxLength(2)
                .IsUnicode(false);
            entity.Property(e => e.週).HasComputedColumnSql("(datepart(week,[生產日期]))", true);
        ...
        modelBuilder.Entity<現有人員查詢>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("現有人員查詢");

            entity.Property(e => e.人員別)
                .IsRequired()
                .HasMaxLength(10)
                .IsUnicode(false);
            entity.Property(e => e.公司mail帳號)
                .HasMaxLength(50)
                .IsUnicode(false);
            entity.Property(e => e.兼任部門代號)
                .HasMaxLength(5)
                .IsUnicode(false);
            entity.Property(e => e.出生日期).HasColumnType("datetime");
            entity.Property(e => e.員工代號)
                .IsRequired()
                .HasMaxLength(6)
                .IsUnicode(false);
            entity.Property(e => e.報到日期).HasColumnType("datetime");
            entity.Property(e => e.姓名)
                .IsRequired()
                .HasMaxLength(10);
            entity.Property(e => e.學歷)
                .HasMaxLength(20)
                .IsUnicode(false);
            entity.Property(e => e.學歷代號)
                .HasMaxLength(3)
                .IsUnicode(false);
            entity.Property(e => e.年初年資).HasColumnType("numeric(17, 6)");
            entity.Property(e => e.年底年資).HasColumnType("numeric(17, 6)");
            entity.Property(e => e.年終獎金)
                .IsRequired()
                .HasMaxLength(1)
                .IsUnicode(false);
            entity.Property(e => e.復職日期).HasColumnType("datetime");
            entity.Property(e => e.復薪年月)
                .HasMaxLength(7)
                .IsUnicode(false);
            entity.Property(e => e.月盈餘基點).HasColumnType("numeric(7, 3)");
            entity.Property(e => e.本外勞)
                .IsRequired()
                .HasMaxLength(2)
                .IsUnicode(false);
            entity.Property(e => e.留職停薪日期).HasColumnType("datetime");
            entity.Property(e => e.目前年資).HasColumnType("numeric(17, 6)");
            entity.Property(e => e.直間接代號)
                .IsRequired()
                .HasMaxLength(2)
                .IsUnicode(false);
            entity.Property(e => e.職稱)
                ...
                .HasMaxLength(16)
                .IsUnicode(false);
            entity.Property(e => e.職等).HasColumnType("numeric(4, 1)");
